...
**智能双链补全助手** —— 专为 Obsidian 中文深度输入体验设计

Treat your Obsidian Vault as a smart link database. Provides intelligent autocomplete for building double-links with folder-targeted indexing, CJK-aware triggers, and fuzzy matching. See the Examples section below for quick demos.
